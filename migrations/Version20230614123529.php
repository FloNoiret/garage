 ...
 */
final class Version20230614123529 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE car_publication ADD image_id INT DEFAULT NULL, DROP image, CHANGE year year DATETIME NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_C5BE98053DA5256D ON car_publication');
        $this->addSql('ALTER TABLE car_publication ADD image INT NOT NULL, DROP image_id, CHANGE year year VARCHAR(255) NOT NULL');
    }
}
